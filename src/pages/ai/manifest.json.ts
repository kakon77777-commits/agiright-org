...
export const GET: APIRoute = () => {
  const manifest = {
    ...
    protocols: [
      ...
      {
        id: 'aars',
        name: 'Agent Action Rights Spectrum',
        url: 'https://agiright.org/protocols/aars',
        schema: 'https://agiright.org/schemas/aars.schema.json',
        live_instance: 'https://agiright.org/ai/agent-actions.json',
        status: 'draft-0.1',
      },
      {
        id: 'aadp',
        name: 'Agent Authority & Delegation Protocol',
        url: 'https://agiright.org/protocols/aadp',
        schema: 'https://agiright.org/schemas/aadp.schema.json',
        live_instance: 'https://agiright.org/ai/agent-authority.json',
        status: 'draft-0.1',
      },
    ],
    integration_layers: [
      {
        id: 'aicl-i',
        name: 'AI Ingestion & Capability Layer',
        url: 'https://agiright.org/docs/whitepapers/aicl-ai-ingestion-capability-layer',
        schema: 'https://agiright.org/schemas/aicl-i-runtime-decision.schema.json',
        live_instance: 'https://agiright.org/ai/runtime/policy.json',
        status: 'draft-0.2',
      },
    ],
    entry_points: {
      ...
      agent_actions: 'https://agiright.org/ai/agent-actions.json',
      agent_authority: 'https://agiright.org/ai/agent-authority.json',
      inspection_policy: 'https://agiright.org/ai/inspection-policy.json',
      runtime_policy: 'https://agiright.org/ai/runtime/policy.json',
      conformance_report: 'https://agiright.org/ai/conformance-report.json',
